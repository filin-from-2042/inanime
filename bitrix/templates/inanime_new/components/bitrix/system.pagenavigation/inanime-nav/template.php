...
<!--                <select name="sort_order" onchange="inanime_new.refreshCatalogBySort(this.value, 209)">-->
<!--                    --><?//
//                    foreach ($arAvailableSort as $key => $val):?>
<!--                        <option value="--><?//= $val[0]; ?><!--;desc">По --><?//= GetMessage('SECT_SORT_' . $key); ?><!-- (по убыванию)</option>-->
<!--                        <option value="--><?//= $val[0]; ?><!--;asc">По --><?//= GetMessage('SECT_SORT_' . $key); ?><!-- (по возрастанию)</option>-->
<!--                    --><?// endforeach; ?>
<!--                </select>-->
<!--            </div>-->
