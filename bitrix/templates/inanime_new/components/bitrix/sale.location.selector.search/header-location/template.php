...
<?else:?>
    ...
    <button type="button" class="btn btn-default ia-btn text-btn yellow-btn location-btn" onclick="$(this).hide().siblings('.bx-sls').show()">
	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="header-location bx-sls <?if(strlen($arResult['MODE_CLASSES'])):?> <?=$arResult['MODE_CLASSES']?><?endif?>" style="display:none;">
