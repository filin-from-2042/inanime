...
else
{
	...
	if ($_REQUEST["filter_history"] !== 'Y')
	{
		...
		foreach ($arResult['ORDERS'] as $key => $order)
		{
			...
			?>
			<div class="col-md-24 col-sm-24 sale-order-list-container">
				<div class="row">
					<div class="col-md-24 col-sm-24 col-xs-24 sale-order-list-title-container">
				...
				<div class="row">
					<div class="col-md-24 sale-order-list-inner-container">
						...
						foreach ($order['PAYMENT'] as $payment)
						{
							...
							<div class="row sale-order-list-inner-row">
								...
								<div class="sale-order-list-inner-row-body">
									<div class="col-md-18 col-sm-16 col-xs-24 sale-order-list-payment">
									...
									if ($payment['PAID'] === 'N' && $payment['IS_CASH'] !== 'Y')
									{
										...
										{
											?>
											<div class="col-md-6 col-sm-8 col-xs-24 sale-order-list-button-container">
								...
								<div class="col-lg-18 col-md-18 col-sm-20 col-xs-24 sale-order-list-inner-row-template">
						...
						foreach ($order['SHIPMENT'] as $shipment)
						{
							...
							<div class="row sale-order-list-inner-row">
								...
								?>
								<div class="col-md-18 col-sm-16 col-xs-24 sale-order-list-shipment">
								...
								{
									?>
									<div class="col-md-4 col-md-offset-2 col-sm-24 sale-order-list-shipment-button-container">
						...
						<div class="row sale-order-list-inner-row">
							<div class="sale-order-list-top-border"></div>
							<div class="col-md-16  col-sm-24 sale-order-list-about-container">
							...
							<div class="col-md-4 col-sm-24 sale-order-list-repeat-container">
							...
							<div class="col-md-4 col-sm-24 sale-order-list-cancel-container">
	...
	else
	{
		...
		foreach ($arResult['ORDERS'] as $key => $order)
		{
			...
			<div class="col-md-24 col-sm-24 sale-order-list-container">
				<div class="row">
					<div class="col-md-24 col-sm-24 sale-order-list-accomplished-title-container">
						<div class="row">
							<div class="col-md-16 col-sm-24 sale-order-list-accomplished-title-container">
							...
							<div class="col-md-8 col-sm-24 sale-order-list-accomplished-date-container">
								<?
								if ($_REQUEST["show_canceled"] !== 'Y')
								{
									?>
				...
				<div class="row">
					<div class="col-md-24 sale-order-list-inner-accomplished">
						<div class="row sale-order-list-inner-row">
							<div class="col-md-6 col-sm-24 sale-order-list-about-accomplished">
							...
							<div class="col-md-6 col-md-offset-12 col-sm-24 sale-order-list-repeat-accomplished">
