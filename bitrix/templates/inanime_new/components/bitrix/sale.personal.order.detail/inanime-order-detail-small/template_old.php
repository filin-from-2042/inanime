...
else
{
	...
	<div class="container-fluid sale-order-detail">
		...
		<div class="col-md-24 col-sm-24 col-xs-24sale-order-detail-general">
			<div class="row">
				<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-general-head">
			...
			<div class="row sale-order-detail-about-order">
				...
				<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-about-order-container">
					<div class="row">
						<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-about-order-title">
					...
					<div class="row">
						<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-about-order-inner-container">
							<div class="row">
								<div class="col-md-8 col-sm-12 sale-order-detail-about-order-inner-container-name">
								...
								<div class="col-md-8 col-sm-12 sale-order-detail-about-order-inner-container-status">
								...
								<div class="col-md-4 col-sm-12 sale-order-detail-about-order-inner-container-price">
								...
								<div class="col-md-4 col-sm-12 sale-order-detail-about-order-inner-container-repeat">
							...
							<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-about-order-inner-container-details">
			...
			<div class="row sale-order-detail-payment-options">
				...
				<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-container">
					<div class="row">
						<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-title">
					...
					<div class="row">
						<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-inner-container">
							<div class="row">
								<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-info">
									<div class="row">
										<div class="col-md-2 col-sm-4 col-xs-4 sale-order-detail-payment-options-info-image"></div>
										<div class="col-md-22 col-sm-20 col-xs-20 sale-order-detail-payment-options-info-container">
							...
							<div class="row">
								<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-methods-container">
									<?
									foreach ($arResult['PAYMENT'] as $payment)
									{
										?>
										<div class="row payment-options-methods-row">
											<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-methods">
												<div class="row sale-order-detail-payment-options-methods-information-block">
													<div class="col-md-4 col-sm-10 col-xs-24 sale-order-detail-payment-options-methods-image-container">
													...
													<div class="col-md-16 col-sm-14 col-xs-20 sale-order-detail-payment-options-methods-info">
													...
													{
														?>
														<div class="col-md-4 col-sm-24 col-xs-24 sale-order-detail-payment-options-methods-button-container">
															<?
													...
													?>
													<div class="sale-order-detail-payment-inner-row-template col-md-offset-6 col-sm-offset-10 col-md-10 col-sm-20 col-xs-24">
												...
												{
													?>
													<div class="row sale-order-detail-payment-options-methods-template col-md-24 col-sm-24 col-xs-24">
							...
							<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-inner-container">
								<?
									foreach ($arResult['SHIPMENT'] as $shipment)
									{
										?>
										<div class="row">
											<div class="col-md-24 col-md-24 col-sm-24 sale-order-detail-payment-options-shipment-container">
												<div class="row">
													<div class="col-md-24 col-md-24 col-sm-24 sale-order-detail-payment-options-shipment">
														<div>
															<div class="col-md-6 col-sm-10 sale-order-detail-payment-options-shipment-image-container">
																<?
															...
															<div class="col-md-14 col-sm-14 sale-order-detail-payment-options-methods-shipment-list">
															...
															<?
																...
																{
																	?>
																	<div class="col-md-4 col-sm-24 sale-order-detail-payment-options-shipment-button-container">
														...
														<div class="col-md-18 col-md-offset-6 col-sm-24 sale-order-detail-payment-options-shipment-composition-map">
															<?
																if (isset($arResult['DELIVERY']['STORE_LIST']))
																{
																	foreach ($arResult['DELIVERY']['STORE_LIST'] as $store)
																	{
																		?>
																		<div class="row">
																			<div class="col-md-24 col-sm-24 sale-order-detail-map-container">
																				<div class="row">
																		...
																		if (strlen($store['ADDRESS']))
																		{
																			?>
																			<div class="row">
																				<div class="col-md-24 col-sm-24 sale-order-detail-payment-options-shipment-map-address">
																					<div class="row">
																		<span class="col-md-4 sale-order-detail-payment-options-shipment-map-address-title">
																			<?= Loc::getMessage('SPOD_STORE_ADDRESS')?>:</span>
																			<span class="col-md-20 sale-order-detail-payment-options-shipment-map-address-element">
															...
															?>
															<div class="row">
																<div class="col-md-24 col-sm-24 sale-order-detail-payment-options-shipment-composition-container">
																	<div class="row">
																		<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-shipment-composition-title">
																							...
																							<?
																								foreach ($shipment['ITEMS'] as $item)
																								{
																									...
																									<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
																										...
																										<div class="sale-order-detail-order-item-nth-4p1"></div>
																										<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
																											<div class="sale-order-detail-order-item-td-title col-xs-14  col-sm-14 col-dm-14 visible-xs visible-sm">
																												<?= Loc::getMessage('SPOD_QUANTITY')?>
																											</div>
			...
			<div class="row sale-order-detail-payment-options-order-content">
				...
				<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-order-content-container">
					<div class="row">
						<div class="col-md-24 col-sm-24 col-xs-24 sale-order-detail-payment-options-order-content-title">
										...
										<div class="sale-order-detail-order-item-table">
											...
											foreach ($arResult['BASKET'] as $basketItem)
											{
												...
												<div class="sale-order-detail-order-item-tr sale-order-detail-order-basket-info sale-order-detail-order-item-tr-first">
													...
													<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
														<div class="sale-order-detail-order-item-td-title col-xs-14 col-sm-10 visible-xs visible-sm">
															<?= Loc::getMessage('SPOD_PRICE')?>
														</div>
														<div class="sale-order-detail-order-item-td-text">
													...
													<div class="sale-order-detail-order-item-td sale-order-detail-order-item-properties bx-text-right">
														<div class="sale-order-detail-order-item-td-title col-xs-14 col-sm-10 visible-xs visible-sm"><?= Loc::getMessage('SPOD_ORDER_PRICE')?></div>
														<div class="sale-order-detail-order-item-td-text">
			...
			<div class="row sale-order-detail-total-payment">
				<div class="col-md-14 col-md-offset-10 col-sm-24 col-xs-24sale-order-detail-total-payment-container">
					<div class="row">
						<ul class="col-md-16 col-sm-12 col-xs-12 sale-order-detail-total-payment-list-left">
							<?
						...
						<ul class="col-md-8 col-sm-12 col-xs-12 sale-order-detail-total-payment-list-right">
							<?
							if (floatval($arResult["ORDER_WEIGHT"]))
							{
								?>
