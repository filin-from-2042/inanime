...
?>
<div class="comment-container ia-reviews-single" id="comments">
        ...
        <div class="reviews-block-outer">
            <div class="reviews-block-inner">
                ...
                ?>" bx-author-id="<?=$res["AUTHOR_ID"]?>" bx-author-name="<?=$res["AUTHOR_NAME"]?>" id="message<?=$res["ID"]?>">
                        ...
                        <td>
                            ...
                            <div class="nickname-rate-container">
                                <span class="nicname"><?
                                    ...
                                    ?></span>
                                <span class='message-post-date comment-date gray-text'><?=$res["POST_DATE"]?></span>
                            </div>
                    ...
                    <tr>
                        <td>
                            <div class="reviews-text part-text gray-text" id="message_text_<?=$res["ID"]?>"><?=$res["POST_MESSAGE_TEXT"]?></div>
                            <?
