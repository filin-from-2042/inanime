...
{
	?>
	<div class="reviews-collapse reviews-minimized button-container" style='position:relative; float:none;'>
		<a class="reviews-collapse-link btn btn-default ia-btn text-btn blue-btn" id="sw<?=$arParams["FORM_ID"]?>" onclick="BX.onCustomEvent(BX('<?=$arParams["FORM_ID"]?>'), 'onTransverse')" href="javascript:void(0);"><?=$arParams['MINIMIZED_EXPAND_TEXT']?></a>
	</div>
	<?
}
?>
