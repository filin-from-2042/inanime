    ...
    <?if ($arParams['SHOW_AUTHOR'] == 'Y'):?>
        ...
        <?else:?>
            <div class="col-sm-12 col-md-10 col-lg-11 left-button-container col-xs-12 registration-container">
                <a type="button" class="link_profile btn btn-default ia-btn text-btn yellow-btn" href="<?=$arParams['PATH_TO_REGISTER']?>?register=yes" onclick="$('#registration-modal').modal();return false;"><?=GetMessage('TSB1_REGISTER')?></a>
            </div>
