        ...
        if (!empty($arResult["DELIVERY"])) {
            ...
            foreach ($arResult["DELIVERY"] as $delivery_id => $arDelivery) {
                                ...
                                <label for="ID_DELIVERY_<?= $delivery_id ?>_<?= $profile_id ?>">
                                    ...
                                    if (count($arDelivery["LOGOTIP"]) > 0):
                                        ...
                                        $arFileTmp = CFile::ResizeImageGet(
                                                        $arDelivery["LOGOTIP"]["ID"], array("width" => "95", "height" => "55"), BX_RESIZE_IMAGE_PROPORTIONAL, true
                                        );
                ...
                <?= htmlspecialcharsbx($arDelivery["TITLE"]) . " (" . htmlspecialcharsbx($arProfile["TITLE"]) . ")"; ?>
                                        ...
                                        <p onclick="BX('ID_DELIVERY_<?= $delivery_id ?>_<?= $profile_id ?>').checked = true;
                        submitForm();">
                ...
                <? endif; ?>
                    ...
                    <div class="radioWrap">
                        <input type="radio"
                               ...
                               onclick="submitForm();"
                               />
                        <label for="ID_DELIVERY_ID_<?= $arDelivery["ID"] ?>" <?= $clickHandler ?>><?= $arDelivery["NAME"] ?></label>
                            <span class="comment">
