...
?>
    <div class="section-personal-header personal">
        ...
        ?>
        <h1 class="ia-page-title">Личный кабинет</h1>
    </div>
    <div class="section-personal personal orders">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-24 col-sm-16 col-md-18 col-lg-18 fields-column orders-table-column">
